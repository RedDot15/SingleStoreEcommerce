...
!function (a) {
    ...
    var q = function (b, c, d, e) {
        ...
        t = r.create('<div class="note-toolbar card-header"/>'), u = r.create('<div class="note-editing-area"/>'),
        ...
        G = r.create(['<div class="note-popover popover in">', '  <div class="arrow"/>', '  <div class="popover-content note-children-container"/>', "</div>"].join(""), function (a, b) {
            ...
            options: {},
            button: function (a, b) {
                return r.create('<button type="button" class="note-btn btn btn-secondary btn-sm" tabindex="-1">', function (a, b) {
            ...
            b.memo("button.style", function () {
                ...
                return d.buttonGroup({
                    ...
                    children: [d.button({
                        ...
                        items: ['<div class="note-palette">', '  <div class="note-palette-title">' + g.color.background + "</div>", "  <div>", '    <button type="button" class="note-color-reset btn btn-secondary" data-event="backColor" data-value="inherit">', g.color.transparent, "    </button>", "  </div>", '  <div class="note-holder" data-event="backColor"/>', "</div>", '<div class="note-palette">', '  <div class="note-palette-title">' + g.color.foreground + "</div>", "  <div>", '    <button type="button" class="note-color-reset btn btn-secondary" data-event="removeFormat" data-value="foreColor">', g.color.resetToDefault, "    </button>", "  </div>", '  <div class="note-holder" data-event="foreColor"/>', "</div>"].join(""),
                        callback: function (b) {
    ...
    a.summernote = a.extend(a.summernote, {
        version: "0.8.8", ui: J, dom: o, plugins: {}, options: {
            modules: {
                editor: U,
                clipboard: V,
                dropzone: W,
