        ...
        ft = FooTable.init('#footable-3', {
            editing: {
                ...
                addRow: function () {
                    ...
                    $editor[0].reset();
                    $editorTitle.text('Create a new color');
                ...
                editRow: function (row) {
                    ...
                    $editor.find('#hexCode').val(values.hexCode);
                ...
                deleteRow: function (row) {
                    swal({
                        ...
                        html: "This will also delete every of product detail and product image relate to this color",
                        type: 'warning',
                        ...
                        if (result.value) {
                            ...
                            $.ajax({
                                type: "Delete",
                                url: "/admin/color/" + row.val().id + "/delete",
                            }).done(function (res) {
                                swal(
                                    'Deleted!',
                                    res.message,
    ...
    $editor.on('submit', function (e) {
        ...
        var row = $modal.data('row'),
            values = {
                ...
                hexCode: $editor.find('#hexCode').val()
            };
