...
// home page 2 Main menu ofcanvas
    ...
    $('.add-to-bag, .addto-icon-btn a').on('click', function (e) {
        ...
        //Paste To Modal:
        // product image
        $('.modal-quickview-container').find('div.quick-product-gallery').children().find('div:first').children().attr('src', productImageSrc1);
        $('.modal-quickview-container').find('div.quick-product-gallery').children().find('div:first').next().children().attr('src', productImageSrc2);

        $('.modal-quickview-container').find('div.quick-product-thumbs').children().children('div:first').children().attr('src', productImageSrc1);
        $('.modal-quickview-container').find('div.quick-product-thumbs').children().children('div:first').next().children().attr('src', productImageSrc2);
