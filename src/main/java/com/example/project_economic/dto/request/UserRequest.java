...
@AllOrNone(groups = Update.class, fields = {"password", "confirmPassword"}, message = "These fields {fields} must be all null or all not null.")
@Match(fields = {"password", "confirmPassword"}, message = "These fields {fields} must match.")
public class UserRequest {
    ...
    @NotBlank(groups = {Create.class,Update.class}, message = "Email is required.")
    ...
    @NotNull(groups = {Create.class, Update.class}, message = "Phone number is required.")
    @Pattern(
            regexp = "^(\\+?[0-9]{10,15})?$",
    ...
    @NotNull(groups = {Create.class, Update.class}, message = "Address is required.")
