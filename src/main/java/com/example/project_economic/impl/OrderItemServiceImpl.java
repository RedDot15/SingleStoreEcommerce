  ...
  public List<OrderItemResponse> getAllByUserId(Long userId) {
    ...
    for (OrderItemEntity orderItemEntity : orderItemEntityList) {
      ...
      SizeEntity foundSizeEntity =
          sizeRepository.findIncludingDeletedById(foundProductDetailEntity.getSizeId());
  ...
  public List<OrderItemResponse> addMyItem() {
    ...
    OrderEntity orderEntity =
        orderRepository.save(
            OrderEntity.builder().userEntity(userRepository.getReferenceById(userId)).build());
    ...
    for (CartItemEntity cartItemEntity : cartItemEntityList) {
      ...
      OrderItemResponse orderItemResponse =
          orderItemMapper.toOrderItemResponse(
