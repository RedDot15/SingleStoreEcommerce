...
public class ColorServiceImpl implements ColorService {
	...
	public Set<ColorResponse> getAll() {
		return new TreeSet<>(colorRepository.findAll().stream()
	...
	public ColorResponse add(ColorRequest colorRequest) {
		...
		// Add & Return
		return colorMapper.toColorResponse(colorRepository.save(colorMapper.toColorEntity(colorRequest)));
	}
	...
	public ColorResponse update(ColorRequest colorRequest) {
		...
		ColorEntity foundColorEntity = colorRepository
