...
public class PermissionServiceImpl implements PermissionService {
    ...
    public PermissionResponse update(PermissionRequest permissionRequest) {
        ...
        // Get old
        PermissionEntity foundPermissionEntity = permissionRepository.findById(permissionRequest.getId())
    ...
    public Long delete(Long id) {
        // Get entity
        PermissionEntity foundPermissionEntity = permissionRepository.findById(id)
                .orElseThrow(() -> new AppException(ErrorCode.PERMISSION_NOT_FOUND));
        // Delete this product
