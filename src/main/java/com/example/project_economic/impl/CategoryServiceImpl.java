...
public class CategoryServiceImpl implements CategoryService {
  ...
  public Long delete(Long id) {
    ...
    for (ProductEntity productEntity : productRepository.findAllByCategoryId(id)) {
      ...
      productDetailRepository.deleteAll(
          productDetailRepository.findAllByProductId(productEntity.getId()));
      productImageRepository.deleteAll(
          productImageRepository.findAllByProductId(productEntity.getId()));
  ...
  public CategoryResponse activate(Long id) {
    ...
    // Save & Return
    return categoryMapper.toCategoryResponse(categoryRepository.save(oldCategoryEntity));
  }
