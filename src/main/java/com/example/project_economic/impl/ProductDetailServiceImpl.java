...
public class ProductDetailServiceImpl implements ProductDetailService {
	...
	public Set<ProductDetailResponse> getAllByProductId(Long productId) {
		...
		// Return result
		return new TreeSet<>(productDetailEntitySet.stream()
	...
	public ProductDetailResponse add(ProductDetailRequest productDetailRequest) {
		...
		if (foundProductDetailEntity != null) {
			...
			ProductDetailResponse productDetailResponse =
					productDetailMapper.toProductDetailResponse(productDetailRepository.save(foundProductDetailEntity));
		...
		ProductDetailResponse productDetailResponse =
				productDetailMapper.toProductDetailResponse(productDetailRepository.save(newProductDetailEntity));
	...
	public ProductDetailResponse update(ProductDetailRequest productDetailRequest) {
		...
		ProductDetailEntity oldProductDetailEntity = productDetailRepository
		...
		// Save & Return
		return productDetailMapper.toProductDetailResponse(productDetailRepository.save(oldProductDetailEntity));
	}
	...
	public Long delete(Long id) {
		// Get entity
		ProductDetailEntity foundProductDetailEntity = productDetailRepository
				.findById(id)
				.orElseThrow(() -> new AppException(ErrorCode.PRODUCT_DETAIL_NOT_FOUND));
	...
	public ProductDetailResponse activate(Long id) {
		...
		// Save & Return
		return productDetailMapper.toProductDetailResponse(productDetailRepository.save(foundProductDetailEntity));
	}
