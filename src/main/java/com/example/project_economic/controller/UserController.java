...
public class UserController {
  ...
  public ResponseEntity<ResponseObject> showMyInfo() {
    ...
    return buildResponse(
        HttpStatus.OK, "My information fetch successfully.", userService.getMyInfo());
  }
  ...
  public ResponseEntity<ResponseObject> add(
    ...
    // Create & Return user
    return buildResponse(
        HttpStatus.OK, "Created new user successfully.", userService.add(userRequest));
  }
  ...
  public ResponseEntity<ResponseObject> update(
    ...
    // Update & Return
    return buildResponse(
        HttpStatus.OK, "Updated user successfully.", userService.update(userRequest));
  }
  ...
  public ResponseEntity<ResponseObject> activate(@PathVariable Long userId) {
    // Deactivate & Return
    return buildResponse(
        HttpStatus.OK, "Activated user successfully.", userService.activate(userId));
  }
  ...
  public ResponseEntity<ResponseObject> deactivate(@PathVariable Long userId) {
    // Deactivate & Return
    return buildResponse(
        HttpStatus.OK, "Deactivate user successfully", userService.deactivate(userId));
  }

  @PostMapping("/register")
  public ResponseEntity<ResponseObject> registerUser(
      @Validated({Create.class, Client.class, Default.class}) @RequestBody
  ...
  public ResponseEntity<ResponseObject> updateInformation(
      @Validated({Update.class, Client.class, Default.class}) @RequestBody
          UserRequest userRequest) {
    // Update & Return user
    return buildResponse(
        HttpStatus.OK, "Updated user successfully.", userService.updateInformation(userRequest));
  }
  ...
  public ResponseEntity<ResponseObject> changePassword(
    ...
    // Update & Return user
    return buildResponse(
        HttpStatus.OK, "Changed password successfully.", userService.changePassword(request));
  }
}
