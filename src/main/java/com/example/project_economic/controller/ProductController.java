...
public class ProductController {
  ...
  public ResponseEntity<ResponseObject> showAll() {
    ...
    return buildResponse(
        HttpStatus.OK, "All products fetched successfully.", productService.getAll());
  }

  @GetMapping("/list/active/by/category/{categoryId}")
  public ResponseEntity<ResponseObject> showActiveProductOfACategory(
  ...
  public ResponseEntity<ResponseObject> showActiveById(@PathVariable Long productId) {
    ...
    return buildResponse(
        HttpStatus.OK, "Product fetch successfully.", productService.getActiveById(productId));
  }
  ...
  public ResponseEntity<ResponseObject> delete(@PathVariable Long productId) {
    ...
    return buildResponse(
        HttpStatus.OK, "Deleted product successfully.", productService.delete(productId));
  }
  ...
  public ResponseEntity<ResponseObject> activate(@PathVariable Long productId) {
    // Activate & Return
    return buildResponse(
        HttpStatus.OK, "Activated product successfully.", productService.activate(productId));
  }
  ...
  public ResponseEntity<ResponseObject> deactivate(@PathVariable Long productId) {
    // Deactivate & Return
    return buildResponse(
        HttpStatus.OK, "Deactivated product successfully.", productService.deactivate(productId));
  }
