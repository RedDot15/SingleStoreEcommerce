...
public class ColorController {
  ...
  public ResponseEntity<ResponseObject> add(
    ...
    // Add & Return color
    return buildResponse(
        HttpStatus.OK, "Created new color successfully.", colorService.add(colorRequest));
  }
  ...
  public ResponseEntity<ResponseObject> update(
    ...
    // Update & Return color
    return buildResponse(
        HttpStatus.OK, "Updated color successfully.", colorService.update(colorRequest));
  }
  ...
  public ResponseEntity<ResponseObject> delete(@PathVariable Long colorId) {
    // Delete & Return id
    return buildResponse(
        HttpStatus.OK, "Deleted color successfully.", colorService.delete(colorId));
  }
}
