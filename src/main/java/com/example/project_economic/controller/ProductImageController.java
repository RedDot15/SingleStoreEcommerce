...
public class ProductImageController {
  ...
  public ResponseEntity<ResponseObject> showAllProductImageOfAProduct(
  ...
  public ResponseEntity<ResponseObject> add(
      @Validated({Create.class, Default.class}) @ModelAttribute
  ...
  public ResponseEntity<ResponseObject> update(
      @Validated({Update.class, Default.class}) @ModelAttribute
          ProductImageRequest productImageRequest) {
