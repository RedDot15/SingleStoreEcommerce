...
public class PermissionController {
    ...
    public ResponseEntity<ResponseObject> showAll(){
        ...
        return buildResponse(
                HttpStatus.OK,
                "All permissions fetch successfully.",
                permissionService.getAll()
        );
    }

    @PostMapping("/add")
    public ResponseEntity<ResponseObject> add(@Validated({Create.class, Default.class}) @RequestBody PermissionRequest permissionRequest){
    ...
    @PutMapping("/update")
    public ResponseEntity<ResponseObject> update(@Validated({Update.class, Default.class}) @RequestBody PermissionRequest permissionRequest){
