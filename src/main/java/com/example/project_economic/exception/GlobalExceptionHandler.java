...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<ResponseObject> handleValidationException(
    ...
    List<ValidationResponse> validationResponseSet =
                ...
                error -> {
                  ...
                  if (error instanceof FieldError) {
                    ...
                    return new ValidationResponse(
                        ...
                        Objects.nonNull(attributes)
                            ? mapAttribute(
                                Objects.requireNonNull(error.getDefaultMessage()), attributes)
  ...
  private String mapAttribute(String message, Map<String, Object> attributes) {
    ...
    if (Objects.nonNull(fields))
      message =
          message.replace("{" + FIELDS_ATTRIBUTE + "}", "[" + String.join(", ", fields) + "]");
    return message;
  }
}
