...
public enum ErrorCode {
    ...
    CATEGORY_ACTIVATION_FAIL(HttpStatus.UNPROCESSABLE_ENTITY, "This category does not have at least 3 active products to activate."),
    // Product
    ...
    PRODUCT_ACTIVATION_FAIL(HttpStatus.UNPROCESSABLE_ENTITY, "This category does not have at least 3 active products to activate."),
    // Product detail
