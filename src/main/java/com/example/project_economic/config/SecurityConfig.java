...
public class SecurityConfig {
    ...
    private final String[] PUBLIC_ENDPOINTS = {"/","/shop/**","/product-detail/**","/category","/faq","/about","/contact","/client/**","/isAuthenticated","/api/product-image/get/**", "/client/user/register-handle","/api/shoppingcarts/*"};
